...
namespace vesuvio {
	...
	*/
	...
	void VulkanContext::initVulkan(const std::string& appName, GLFWwindow* window) {
		this->window = window;
	...
	void VulkanContext::framebufferResizeCallback(VulkanContext* vkContext, int width, int height) noexcept {
